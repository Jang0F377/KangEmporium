...
const HeaderComponent = () => {
  ...
  return (
    <div>
      <header className="flex flex-col bg-color-primary mx-72 ">
        <div className="flex flex-row justify-end pr-1 ">
          <div
            hidden={authorizedUser}
            className="p-1 hover:text-blue-600 hover:cursor-pointer font-poppins"
          ...
          <div
            hidden={!authorizedUser}
            className="p-1 pr-2 hover:text-blue-600 hover:cursor-pointer font-poppins"
            onClick={logoutFlow}
          >
            Logout ->
          </div>
      ...
      >
        <div className="w-72 lg:w-96 text-2xl bg-color-light font-playfair">
          <div className="flex flex-row justify-around">
            <div className="text-4xl underline decoration-2 pt-1 underline-offset-8">
              My Cart ({getCartCount()})
            </div>
            <div className="text-3xl pt-1 ">Total: $ {getCartSubtotal()}</div>
          </div>
