      ...
      {loading ? (
        ...
        <div className="flex flex-col rounded items-center  pt-4">
          ...
          <div className="flex flex-col">
            <Input
              className="flex-1 mt-10 bg-white lg:w-72 rounded p-2"
              type="email"
              value={email}
            ...
            />
            <div
              onClick={() => alert("Functionality not yet set up")}
              className="text-sm text-end mt-1.5 hover:cursor-pointer hover:text-blue-600"
            >
