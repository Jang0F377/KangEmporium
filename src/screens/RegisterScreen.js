...
const RegisterScreen = () => {
    ...
    return(
        <div className='flex lg:pb-11 flex-col bg-gray-200 mx-96 rounded items-center  pt-4'>
            {loading ?
                <LoadingScreen/> : success ?
                    ...
                    <div className='flex flex-col rounded items-center  pt-4'>
                        ...
                        <div className='flex flex-col'>
                            <Input className='flex-1 mt-9 bg-white lg:w-72 rounded p-2' type='text' value={firstName}
                                   onChange={(event) => setFirstName(event.target.value)}
                                   placeholder={'First Name'}/>
                            <Input className='flex-1 mt-9 bg-white lg:w-72 rounded p-2' type='email' value={email}
                                   onChange={(event) => setEmail(event.target.value)}
                                   placeholder={'Email'}/>
                            <Input className='flex-1 mt-9 bg-white lg:w-72 rounded p-2' type='password' value={password}
                                   onChange={(event) => setPassword(event.target.value)}
                                   placeholder={'Password'}/>
                            <Input className='flex-1 mt-9 bg-white lg:w-72 rounded p-2' type='password' value={confirmPassword}
                                   onChange={(event) => {
