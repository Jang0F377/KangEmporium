...
const DetailedProductScreen = () => {
  ...
  return (
    <div className="flex flex-col bg-gray-200 font-raleway mx-60  pt-6">
      <div className="text-6xl text-center p-1 mb-2 font-poppins">
        {item.name}
      </div>
      {item ? (
        <div className="flex">
          ...
          <div className="flex flex-col p-5">
            <div className="text-2xl p-1.5 underline">Description</div>
            <div className="text-xl p-1.5">{item.description}</div>
            <div className="text-5xl text-right mr-4 mt-10">$ {item.price}</div>
            <div className="flex flex-row justify-between">
              <div className="mt-10 text-lg">
                Left in stock: {item.countInStock}
              </div>
              <div className="flex flex-row">
                <div className="my-auto rounded-full mt-16 mr-8 p-1">
                  Add to cart
                </div>
                <div
                  onClick={handleClick}
                ...
                >
                  <Player
                    ...
                    loop={false}
                    src={
                      "https://assets9.lottiefiles.com/packages/lf20_4dz2pspl.json"
                    }
